    ...
    Tables: {
      ...
      battery_assessments: {
        Row: {
          ...
          has_existing_battery: boolean;
          existing_battery_kwh: number | null;
          monthly_bill_eur: number | null;
          annual_consumption_kwh: number | null;
          daily_consumption_kwh: number | null;
          peak_daily_kwh: number | null;
          occupants: number | null;
          has_ac: boolean | null;
          has_pool: boolean;
          consumption_confidence: string | null;
          backup_hours: number | null;
          recommended_battery_kwh: number | null;
          minimum_battery_kwh: number | null;
          optimal_battery_kwh: number | null;
          estimated_cost_eur: number | null;
          total_score: number;
          grid_vulnerability_score: number;
          consumption_score: number;
          arbitrage_score: number;
          solar_synergy_score: number;
        ...
        Update: Partial<Database["public"]["Tables"]["battery_assessments"]["Insert"]>;
      };
    };
...
export type BatteryRecommendation = "highly_recommended" | "recommended" | "consider" | "low_priority";
